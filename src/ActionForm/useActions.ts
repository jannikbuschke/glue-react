...
function postRequestInit(values: any, intent: "validate" | "execute") {
    return {
        ...
        headers: {
            "x-action-intent": intent, "content-type": "application/json"
        },
    }
}

export function useActions({ entityName, actionName, apiVersion, onSuccessfulSubmit }: UseActionProps): UseActionsResponse {
