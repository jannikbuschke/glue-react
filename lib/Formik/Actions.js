...
export var PatchAction = function (props) { return (React.createElement(Button, tslib_1.__assign({ style: { margin: "3px" } }, props), "Save")); };
var DeleteAction = /** @class */ (function (_super) {
    ...
    DeleteAction.prototype.render = function () {
        ...
        return (React.createElement(Button, { loading: loading, style: { marginLeft: "3px" }, type: "danger", 
...
export var PostAction = function (props) { return React.createElement(Button, tslib_1.__assign({}, props), "Create"); };
