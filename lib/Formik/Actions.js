...
export var PatchAction = function (props) { return React.createElement(Button, tslib_1.__assign({}, props), "Save"); };
var DeleteAction = /** @class */ (function (_super) {
    ...
    DeleteAction.prototype.render = function () {
        ...
        return (React.createElement(Button, { loading: loading, type: "danger", 
