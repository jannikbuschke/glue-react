...
var Pages = function (props) { return (React.createElement(React.Fragment, null, props.items.map(function (item, index) { return (React.createElement(MasterDetailContainer, { key: index },
